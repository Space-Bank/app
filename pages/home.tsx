...
const Home: NextPage = () => {
  return (
    ...
    >
      <div
        id="home"
        className="lg:mt-0 flex flex-col lg:flex-row z-10 w-full justify-evenly items-center h-full py-48"
      >
        <div className="z-0 backdrop-blur rounded-full hidden lg:flex mx-6">
          <Image src="/hero.png" height={666} width={666} />
        </div>

        <div
          className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl flex flex-col
        ...
        >
          <div className="pr-20 font-saira-b">
            ...
            <p># ONE STOP SHOP</p>
            <p>
              TO <span className="text-primary">PLAY</span> AND{" "}
          ...
          <div className="flex items-center space-x-8 mt-12 w-screen">
            <Link href="mint">
              <button
                className="bg-primary px-3 py-2.5 text-xl min-w-fit
        ...
        <div className="z-0 rounded-full lg:hidden mt-20">
          <Image src="/hero.png" height={444} width={444} />
        </div>
      </div>
