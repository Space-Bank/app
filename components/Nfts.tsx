    ...
    >
      ...
      <div className="flex flex-col space-y-12 mt-24">
        <div className="flex flex-col sm:flex-row space-y-6 sm:space-y-0 sm:space-x-12 md:space-x-20 lg:space-x-32 w-full px-8">
          ...
          <div>
            <Image src="/nfts_02.png" width={365} height={365} />
          </div>
          ...
          <div className="flex flex-col text-black">
            ...
            <div className="mt-4 w-64 list-disc space-y-2 font-saira-m">
              The Mob boss NFTs run the show here in the Space Bank, providing
              bonuses to all aspects of it. Mob bosses will pay lower transfer
              taxes in the escrow service, have access to their own planning
              room for their heists, and be able to take their chances with the
              vaults.
            </div>
            ...
            <ul className="mt-4 w-64 list-disc space-y-2 font-saira-m">
              ...
              <li>FIRST 1K MOB BOSSES PLANNING ROOM AIRDROP</li>
